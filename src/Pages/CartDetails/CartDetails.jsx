...
const CartDetails = () => {
    ...
    const url = `https://car-doctor-server-with-jwt-amber.vercel.app/bookings?email=${user?.email}`;
    ...
    const handleDelete = id => {
        ...
        if (proceed) {
            fetch(`https://car-doctor-server-with-jwt-amber.vercel.app/bookings/${id}`, {
                method: 'DELETE',
            })
                .then(res => res.json())
                .then(data => {
